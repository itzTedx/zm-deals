  ...
  return (
    <Tabs defaultValue="tab-1">
      ...
      <TabsContent value="tab-4">
        <p className="pt-1 text-center text-muted-foreground text-xs">Content for Tab 4</p>
      </TabsContent>
      <TabsContent value="tab-5">
        <p className="pt-1 text-center text-muted-foreground text-xs">Content for Tab 5</p>
      </TabsContent>
      <TabsContent value="tab-6">
        <p className="pt-1 text-center text-muted-foreground text-xs">Content for Tab 6</p>
      </TabsContent>
    </Tabs>
  );
}
